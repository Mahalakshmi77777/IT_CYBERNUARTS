...
import '../../admin/data/club_repository.dart';
import '../../admin/providers/admin_providers.dart';

class ClubDetailUserScreen extends ConsumerWidget {
  final String clubId;
  const ClubDetailUserScreen({super.key, required this.clubId});
            ...
            child: Column(
              ...
              children: [
                ...
                eventsAsync.when(
                  ...
                  data: (events) {
                    if (events.isEmpty) {
                      return const Text('No events for this club yet');
                    }
                    return Column(
                      children: events
                          .map((e) => Padding(
